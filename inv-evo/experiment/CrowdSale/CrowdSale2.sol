...
import './files/SafeMathSpec.sol';

contract Crowdsale2 {

    using SafeMathSpec for uint256;
    //using SafeERC20 for IERC20Spec;

    // The token being sold
    ERC20Spec private _token;
    ...
    // So, if you are using a rate of 1 with a ERC20SpecDetailed token with 3 decimals called TOK
  ...
  constructor () public {
    ...
    _openingTime = 1709878400;
    _closingTime = 4112794006;
